...
(defn count-lines
  ...
  ([files reader]
   (count-lines files reader build-files/is-existing-file?))
...
(defn line-numbers
  ...
  * `stats-root-dir` directory the code is analyzed
  ...
  [stats-root-dir]
  (let [clj-total-nb-lines (count-lines (build-files/search-files stats-root-dir
                                                            "**{.clj,.cljs,.cljc}")
                                        slurp)
        clj-test-nb-lines (count-lines (build-files/search-files stats-root-dir

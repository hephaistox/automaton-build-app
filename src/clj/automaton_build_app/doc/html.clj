(ns automaton-build-app.doc.html
  "Manipulate html"
  (:require [automaton-build-app.doc.markdown-to-html :as build-to-html-markdown]
...
(defn header-str [{:keys [logo-path header-id]}] (str (hiccup2/html (hephaistox-logo logo-path header-id))))

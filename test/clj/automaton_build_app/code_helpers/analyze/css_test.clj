(ns automaton-build-app.code-helpers.analyze.css-test
  (:require
   [automaton-build-app.code-helpers.analyze.css :as sut]
...
(deftest css-pattern-test
  (testing "Detect class string"
    (is (not (nil?
              (build-filerepo-text/search-line sut/css-pattern
                                               "This :class \"should be discovered"))))
    (is (not (nil?
              (build-filerepo-text/search-line sut/css-pattern
                               "This :class     \"should be discovered"))))
    (is (nil? (build-filerepo-text/search-line sut/css-pattern

...
(deftest symbol-to-fn-call-test
  ...
  (testing "Non existing functions are ok" (is (nil? (sut/symbol-to-fn-call 'automaton-build-app.utils.namespace-test/foo2 "bar"))))
  (testing "Non existing namespaces are ok" (is (nil? (sut/symbol-to-fn-call 'automaton-build-app.utils.namespace-test2/foo "bar")))))

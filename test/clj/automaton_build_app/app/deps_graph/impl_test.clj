(ns automaton-build-app.app.deps-graph.impl-test
  (:require [automaton-build-app.app.deps-graph.impl :as sut]
            [automaton-build-app.data-structure.graph.apps-stub :as graph-apps-stub]

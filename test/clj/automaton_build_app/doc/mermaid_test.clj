...
(deftest need-to-update?
  (let [older-test-file (build-edn-utils/create-tmp-edn "older-test-file")
    ...
    (testing "The newer file is detected as so" (is (sut/need-to-update? (str newer-test-file ".mermaid") older-test-file)))
    (testing "The older file is detected as so" (is (not (sut/need-to-update? (str older-test-file ".mermaid") newer-test-file))))
